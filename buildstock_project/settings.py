"""
Django settings for buildstock_project project.
...
SECRET_KEY = 'django-insecure-zc6n__q_@1763ryfws9s=jr8ljou10_$#3@4ajf91q%n!s3_mh'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.vfs.cloud9.us-east-1.amazonaws.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'buildstock_project.urls'
...
WSGI_APPLICATION = 'buildstock_project.wsgi.application'
...
# AWS configuration for BuildStock
